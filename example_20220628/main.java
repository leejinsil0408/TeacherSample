...
//import package0004_gameSlimeLand.slime.slimeNotUse;
//import package0005_invenItemOverridingExample.*;
//import package0006_inheritanceExample.*;
//
//import package0007_sandwich.*;
//import example_20220628.package0007_sandwich.childClass_sandwich_anotherPackage;
//
...
//        package0004_gameSlimeLand.slime.redSlime red_1_slime = new redSlime(input_hp, input_mp, arrSlimeName[num], arrSlimeName[num]);
//        input_hp = (int)(Math.random()*100);
//        input_mp = (int)(Math.random()*30);
//        package0004_gameSlimeLand.slime.redSlime red_2_slime = new redSlime(input_hp, input_mp, arrSlimeName[num], arrSlimeName[num]);
//
...
//            int input_mp = 3;
//
//            slimeNotUse slime_A = new slimeNotUse(input_name_1, input_hp, input_mp);
//            slimeNotUse slime_B = new slimeNotUse(input_name_2, input_hp, input_mp);
//            slimeNotUse slime_C = new slimeNotUse(input_name_3, input_hp, input_mp);
//            slimeNotUse slime_D = new slimeNotUse(input_name_4, input_hp, input_mp);
//
//            slime_A.info();
//            slime_B.info();
//            slime_C.info();
